...
const SuccessSummery = () => {
    return (
        <div className='mt-16'>
            <h2 className='text-3xl text-center font-bold text-green-400 mb-5'>Our Success Summary</h2>
            <div className="stats shadow-lg lg:w-1/2 mx-auto flex justify-center">
                <div className="stat">
